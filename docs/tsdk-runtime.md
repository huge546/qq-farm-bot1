...
项目当前使用 `core/src/utils/tsdk.wasm`，来源为本次小游戏资源中的 TSDK `v3.9.0.1787640848`，文件大小为 161,097 bytes，SHA-256 为：

```text
9ceb64e05a1b1a96666d77d938e0d9e6131864a01480b6b424358a8e891ec8da
```
...
从 `v3.9.0.1787056896` 升级至 `v3.9.0.1787640848` 后完成了以下静态、离线和实机兼容性核对：
...
当前 `v3.9.0.1787640848` 已覆盖 Login、普通请求、天气活动完整写链路、持续 AntiData 和 25 秒 Heartbeat。后续验证重点仍包括更长时间的非空回灌稳定性、Token 时序和服务端主动断线行为。
